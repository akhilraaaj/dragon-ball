  ...
  return (
    <div className="px-10  bg-[rgb(238,46,43)]">
      <div className="flex items-center justify-between">
        <div className="p-10">
          <h1 className="text-xl font-extrabold text-[#FCF9BE] mb-4">Characters: <span className='text-[#243763]'>58</span></h1>
          <h1 className="text-xl font-extrabold text-[#FCF9BE]">Transformations: <span className='text-[#243763]'>49</span></h1>
        </div>
